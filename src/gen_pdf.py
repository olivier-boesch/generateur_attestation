...
debut = u"Je soussigné(e),\n\nMme/M {nom:s} {prenom:s}\n\nné(e) le : {date_naissance:s} à {lieu_naissance:s}\n\nDeumeurant : {" \
        ...
        "autorisé par le décret n°2020-1310 du 29 octobre 2020 prescrivant les mesures générales nécessaires pour faire " \
        "face à l'épidémie de Covid19 dans le cadre de l'état d'urgence sanitaire"
...
motifs = OrderedDict([
        ...
        ("Déplacement pour achats/culture/culte", "Déplacements pour se rendre dans un établissement culturel "
                                                  "autorisé ou un lieu de culte; déplacements pour effectuer des " \
                                                  "achats de biens, pour des services dont la fourniture est autorisée, " \
        ...
        ("Personne en situtation de handicap", "Déplacement des personnes en situation de handicap et leur " \
                                               "accompagnant;"),
        ("Activité physique", "Déplacements en plein air ou vers un lieu de plein air, sans changement du lieu de " \
                              "résidence, dans la limite de trois heures quotidiennes et dans un rayon maximal de " \
                              "vingt kilomètres autour du domicile, liés soit à l'activité physique ou aux loisirs " \
                              "individuels, à l'exclusion de toute pratique sportive collective et de toute proximité " \
